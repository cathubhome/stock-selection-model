...
# ==================== 加载输出结果 ====================
def load_outputs() -> tuple[pd.DataFrame | None, dict, pd.DataFrame | None, pd.DataFrame | None, dict]:
    paths = output_paths()
    ...
    return picks, metrics, importance, periods, backtest_metrics
...
# ==================== 当前候选页 ====================
    ...
    st.header("5. 当前候选")
    picks, metrics, importance, _, _ = load_outputs()
